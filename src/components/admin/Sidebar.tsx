  ...
  return (
    <aside className="w-64 bg-oxford min-h-screen text-white p-6 flex flex-col gap-8 shadow-xl">
      ...
      <nav className="flex flex-col gap-2 flex-1">
        ...
        <Link href="/admin/dashboard" className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-white/10 transition-colors text-sm font-medium group">
          <LayoutDashboard className="h-4 w-4 text-gray-400 group-hover:text-purple transition-colors" />
          Dashboard
        </Link>
        
        <Link href="/admin/products" className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-white/10 transition-colors text-sm font-medium group">
          <Package className="h-4 w-4 text-gray-400 group-hover:text-purple transition-colors" />
          Productos
        </Link>
        
        <Link href="/admin/orders" className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-white/10 transition-colors text-sm font-medium group">
          <ShoppingCart className="h-4 w-4 text-gray-400 group-hover:text-purple transition-colors" />
          Órdenes
        </Link>
        
        <Link href="/admin/users" className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-white/10 transition-colors text-sm font-medium group">
          <Users className="h-4 w-4 text-gray-400 group-hover:text-purple transition-colors" />
          Usuarios
        </Link>
        
        <Link href="/admin/notifications" className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-white/10 transition-colors text-sm font-medium group">
