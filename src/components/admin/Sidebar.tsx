  ...
  return (
    <aside className="w-64 bg-oxford min-h-screen text-white p-6 flex flex-col gap-8 shadow-xl">
      ...
      <div className="pt-6 border-t border-white/10">
        <button className="flex items-center gap-3 px-3 py-2 w-full rounded-xl hover:bg-red-500/10 hover:text-red-400 transition-colors text-sm font-medium group text-gray-400">
